...
(function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 12, 12, 309);
    			add_location(h2, file, 16, 24, 488);
    			attr_dev(div0, "class", "card-title");
    			add_location(div0, file, 15, 20, 439);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file, 14, 16, 401);
    			add_location(p, file, 19, 16, 576);
    			set_custom_element_data(cool_button, "alert", true);
    			add_location(cool_button, file, 22, 16, 649);
    			attr_dev(div2, "class", "card-body");
    			add_location(div2, file, 13, 12, 361);
    			attr_dev(div3, "class", "card");
    			add_location(div3, file, 11, 8, 278);
    			attr_dev(div4, "class", "card-container");
    			add_location(div4, file, 10, 4, 241);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ card_title, card_desc, card_img, Button });
